...
class Sparkplot:
    ...
    def plot_sparkline(self):
        ...
        if self.type.startswith('line'):
            ...
            plot(range(num_points), self.data, color='gray',markerfacecolor='red',marker='o',markersize=2.5)
        elif self.type.startswith('bar'):
        ...
        yrange = max_data - min_data
        axis([-1, num_points, min_data-yrange/10, max_data+yrange/10 ])                
        #axis([-1, num_points, -5, ymax ])                
        #axis('tight')
    ...
    def generate_output_file(self):
        ...
        if self.verbose:
            print "Generating output file " + self.output_file + '.pdf'
        savefig(self.output_file, format='pdf')
